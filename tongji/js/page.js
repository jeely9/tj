$.fn.extend({
    paging: function(option) {
        ...
        function getCurrentIndex(){
            return obj.find(".active").index();
        }
        function getCurrentPage(){
            return parseInt(obj.find("li").eq(getCurrentIndex()).text());
        }
        function resetPage(start){
            var objPage = obj.find("li");
        ...
        function makePage(start,isHome,isEnd) {  //生成页码
            ...
            html = '<li id="pre" class="home"><a href="#">&laquo;</a></li>';
            for (var i = start; i <= endPage; i++) {
                html += '<li class="page" id="uipage-nav'+ i +'"><a href="#">' + i + "</a></li>";
            }
            html += '<li id="next" class="end"><a href="#">&raquo;</a></li>';
            obj.html(html);
            if(!isHome || start == 1){
                showHome(false);
            }
        ...
        obj.find("#next").click(function(){
            ...
            if(currentIndex == pageSize + 1) {
                ...
                light(obj.find("li").eq(showPageIndex));
            }
